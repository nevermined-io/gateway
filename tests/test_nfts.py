...
def test_nft_access(client, provider_account, consumer_account):
    ...
    # did = 'did:nv:773d494c0d70359e03d8b37516258f523956a73e7c9a49400cded517037d0f37'
    ...
    tx_hash = keeper.nft_holder_condition.fulfill(
        agreement_id, asset_id, consumer_account.address, nft_amounts, consumer_account
    )
    ...
    assert event, 'no event for NFTAccessCondition.Fulfilled'
